            ...
            <form className="text-center mx-auto w-3/4 ">
              ...
              <div className="w-4/5 mx-auto text-left py-4">
                ...
                <div className="my-4 flex items-center gap-4">
                  ...
                  />
                  <p className="text-sm">
                    Share my registration data with Sonic Scoop's content providers
                ...
                <p className="my-4 text-xs">
                  ...
                  <Link to="/" className="text-green-400">
                    Sonic Scoop's Terms and Condition
                  </Link>{" "}
                  of Use.
                </p>
                <p className="my-4 text-xs">
                  To learn more about how Sonic Scoop collects, uses, shares and
                  protects your personal data, please see
                  <Link to="/" className="text-green-400">
                    Sonic Scoop's Privacy Policy.
                  </Link>{" "}
                </p>
              </div>
